...
def choose_mean_range(b,thz0 = 0,thzh = 0,dxmax = 0,sizemx = 2,sizemy = 2):
    ...
    f = (abs(x[:,2]) < 2.9) * (abs(x[:,1]) < 1 * 1000 / 25) * (abs(x[:,0]) < 3.5*1000.0 / 25) * (abs(x[:,0]) > 1 * 1000 / 25)
    ba=x[f,:]
    px2a=ba[:,0]
    py2a=ba[:,1] + sizemy / 2
...
def correct_reg_angle(b1=None,b2=None,thz0=None,thzh=None,dxmax=None,yaw1=None,show=None,sizemx=None,sizemy=None):
...
def correct_reg_angleRGB(b1=None,b2=None,trgb1=None,trgb2=None,thz0=None,thzh=None,dxmax=None,yaw1=None,show=None,sizemx=None,sizemy=None,*args,**kwargs):
